...
vector<Point> intersection(Line l1, Line l2) //copied from Line.hpp
{
    vector<Point> vec;
    double a1 = l1.slope();
    double a2 = l2.slope();
    ...
    if (s1!=s2){
        ...
        vec.push_back(Point pstar(xstar, ystar));
    }
    return vec;
}

vector<Point> intersection_SS(Segment segment1,Segment segment2)
{
    vector<Point> vec;
    ...
    Point inter_point= intersection(Line line1,Line line2);
     if ((0=<inter_point.getx()-segment1._point1.getx()/segment1._point2.getx()-segment1._point1.getx()<=1) and 
    (0=<inter_point.gety()-segment1._point1.gety()/segment1._point2.gety()-segment1._point1.gety()<=1) and 
    (0=<inter_point.getx()-segment2._point1.getx()/segment2._point2.getx()-segment2._point1.getx()<=1) and 
